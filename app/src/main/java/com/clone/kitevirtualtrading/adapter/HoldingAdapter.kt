package com.clone.kitevirtualtrading.adapter
...
import com.clone.kitevirtualtrading.ui.HoldingFragment
...
class HoldingAdapter(private val userList: List<Item2>, private val itemClickListener: HoldingFragment) :
    ...
    interface ItemClickListener {
        fun onItemClick(item: Item2, fluctuationText: String, sell : String)
    }
